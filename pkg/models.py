...
class UserRegistration(db.Model):
    regid = db.Column(db.Integer, autoincrement=True,primary_key=True)
...
class Breakout(db.Model):
    ...
    break_title = db.Column(db.String(20),nullable=False)
    break_image = db.Column(db.String(120),nullable=True)
    break_status = db.Column(db.Enum('1','0'),nullable=False)
    break_date = db.Column(db.DateTime(), default=datetime.utcnow)
